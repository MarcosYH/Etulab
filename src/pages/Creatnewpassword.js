...
import image_newpassword from "../assets/image_newpassword.png";
...
export default function Creatnewpassword({ match }) {
  ...
  return (
    <div>
      <div className=" flex flex-col md:flex-row justify-center items-center my-2 mx-5 mt-40 ">
        <div className="w-full px-6 py-4 mt-6 overflow-hidden sm:max-w-lg sm:rounded-lg">
          ...
          <img src={image_newpassword} alt="image_newpassword" />
      </div>
    </div>
  );
}
